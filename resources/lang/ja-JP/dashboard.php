...
return [
    ...
    'incidents' => [
        ...
        'updates'                  => [
            'title'   => ':incident の更新情報',
            'count'   => '{0}更新なし|[1]一つの更新|[2]二つの更新|[3,*]いくつかの更新',
            'add'     => [
                'title'   => '障害の更新情報を作成',
                'success' => '障害の更新情報が作成されました。',
                'failure' => '障害の更新情報が作成に失敗しました。',
            ],
            'edit' => [
                'title'   => '障害の更新情報を編集',
                'success' => '障害の更新情報が編集されました。',
                'failure' => '障害の更新情報が編集に失敗しました。',
            ],
        ],
        'reported_by'              => ':user によって報告されました',
        'add'                      => [
            'title'   => '障害情報の報告',
 ...
 // Incident templates
    ...
    'subscribers' => [
        ...
        'description_disabled' => 'この機能を利用するにはメールサーバーの設定が完了していることと、購読者がいる必要があります。',
        'verified'         => '認証済',
        'not_verified'     => '未認証',
