...
return [
    ...
    */
    ...
    'required_unless'      => 'valuesが :other よりも小さい時、:attribute フィールドは必須です。 ',
    'required_with'        => ':value の値が存在する場合、:attribute フィールドは必須です。',
    'required_with_all'    => ':value の値が存在する場合、:attribute フィールドは必須です。',
    'required_without'     => ':values が空欄の場合は :attribute フィールドは必須です。',
    'required_without_all' => ':values が空欄の場合は :attribute フィールドは必須です。',
